...
<head>
	...
	<style id="mobile-refinements-inline">
		...
		@media screen and (max-width: 768px) {
			...
			html.is-home.banner-as-cover.banner-as-cover .cover-scroll-down,
			html.is-home.banner-as-cover.banner-as-cover .banner::after,
			html.is-home.banner-as-cover.banner-as-cover .banner::before {
				display: none !important;
			}
